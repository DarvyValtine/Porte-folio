...
const reiperExperiences = [
  ...
  },
  {
    ...
    title:
      "Travailleuse sociale et responsable du dispositif Mineurs Incarcérés",
    org: "REIPER — Projet « Tobatela bana »",
...
const acbefExperiences = [
  ...
  },
  {
    period: "2019 — 2021",
    title:
      "Présidente du Bureau National du Mouvement d'Action des Jeunes & Membre du Comité Exécutif National",
    org: "ACBEF (bénévole)",
  },
  {
    period: "2016 — 2020",
...
const publications = [
  {
    title:
      "Congo/Société : Le divorce des parents, l'une des principales causes conduisant les enfants en situation de rue",
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
            <div>
              <h3 className="mb-5 font-serif text-xl font-semibold text-foreground">
                Réseau des Intervenants sur le Phénomène des Enfants en Rupture
                — REIPER
              </h3>
